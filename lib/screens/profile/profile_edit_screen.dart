...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  static const _activityOptions = ['Düşük', 'Orta', 'Yüksek', 'Çok aktif'];
  ...
  Future<void> _loadData() async {
    try {
      ...
      // Load health profile
      final hp = await UserHealthProfileRepository.instance
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    _buildSection('🏥 Sağlık Bilgileri', _buildHealthInfo()),
  ...
  Widget _buildSection(String title, Widget child) {
    return Column(
      ...
      children: [
        ...
        SoftCard(padding: const EdgeInsets.all(16), child: child),
      ],
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        _buildChipGroup(
          ...
          selected: _allergies,
          onToggle: (v) => _toggleSet(v, _allergies, noneKeys: {'Yok'}),

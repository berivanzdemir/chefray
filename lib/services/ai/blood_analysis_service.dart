...
class BloodAnalysisService {
    ...
    try {
      ...
      if (!ocrResult.success || ocrResult.isEmpty) {
        return BloodAnalysisResult(
          ...
          safetyWarning:
              'Bu değerlendirme yalnızca beslenme kişiselleştirmesi içindir. '
  ...
  String _getNutritionNote(String normalizedName, String status) {
    ...
    final notes = <String, String>{
      ...
      'vitamin_d':
          'D vitamini kaynakları: yağlı balık, yumurta sarısı, güneş ışığı.',
      ...
      'triglyceride':
          'Trigliserid düşürmeye yardımcı: omega-3, düşük şeker, egzersiz.',
      'glucose':
          'Kan şekeri dengesi için: düşük glisemik indeksli besinler, lif.',
      'hba1c':
          'Uzun vadeli şeker dengesi için: tam tahıllar, sebzeler, düzenli öğün.',
    };

...
class SpoonacularService {
  Future<List<RecipeModel>> getRecipes({String query = '', int number = 10}) async {
    // TODO: Spoonacular/External API disabled. All requests are routed to SupabaseRecipeRepository.
    debugPrint('SpoonacularService.getRecipes: External API bypassed. Fetching from Supabase...');
    try {

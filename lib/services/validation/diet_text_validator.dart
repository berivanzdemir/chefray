...
class DietTextValidator {
  ...
  static const _positiveMealSignals = [
    'kahvaltı', 'ara öğün', 'ara ogun', 'öğle', 'ogle', 'akşam', 'aksam',
    'gece öğünü', 'gece ogunu', 'öğün', 'ogun', 'diyet', 'liste',
    'beslenme', 'gram', 'porsiyon', 'kalori', 'kcal',
  ];

  static const _positiveFoodSignals = [
    'yumurta', 'peynir', 'zeytin', 'yoğurt', 'yogurt', 'tavuk',
    'balık', 'balik', 'salata', 'sebze', 'meyve', 'yulaf',
    'çorba', 'corba', 'bulgur', 'pirinç', 'ekmek',
    'domates', 'salatalık', 'biber', 'ıspanak', 'ispanak',
    'brokoli', 'havuç', 'patates', 'soğan', 'sogan',
    'mercimek', 'nohut', 'fasulye', 'makarna', 'pilav',
    'kinoa', 'chia', 'keten', 'ceviz', 'badem',
    'zeytinyağı', 'zeytinyagi', 'tereyağı', 'tereyagi',
    'bal', 'reçel', 'receller', 'şeker', 'seker',
    'kepek', 'tam buğday', 'tam bugday', 'çavdar', 'cavdar',
    'ton balığı', 'ton baligi', 'somon', 'levrek', 'çupra', 'cupra',
    'köfte', 'kofte', 'et', 'kıyma', 'kiyma',
    'süt', 'sut', 'ayran', 'kefir', 'peynir altı suyu',
    'humus', 'tahin', 'avokado', 'muz', 'elma',
    'portakal', 'mandalina', 'üzüm', 'uzum', 'çilek', 'cilek',
    'karpuz', 'kavun', 'ananas', 'yaban mersini',
    'tarif', 'yemek', 'öneri', 'oneri', 'plan',
    ...
    'kuşluk', 'kusluk', 'ikindi',
  ];

  static const _negativeLabSignals = [
    'hemogram', 'glukoz', 'glucose', 'ldl', 'hdl',
    'trigliserid', 'triglyceride', 'ferritin', 'tsh',
    'hgb', 'hemoglobin', 'eritrosit', 'erythrocyte',
    'lökosit', 'leukocyte', 'laboratuvar', 'laboratory',
    'referans aralığı', 'referans araligi', 'reference range',
    'biyokimya', 'biochemistry', 'tam kan sayımı', 'tam kan sayimi',
    'complete blood count', 'sonuç', 'sonuc', 'birim', 'unit',
    'hba1c', 'a1c', 'alt', 'ast', 'kreatinin', 'creatinine',
    'üre', 'ure', 'crp', 'wbc', 'rbc', 'plt',
    'trombosit', 'platelet', 'demir', 'iron', 'kalsiyum', 'calcium',
    'magnezyum', 'magnesium', 'sodyum', 'sodium', 'potasyum', 'potassium',
    'albümin', 'albumin', 'total protein', 'total kolesterol',
    'total cholesterol', 'ürük asit', 'uric acid', 'sedimentasyon',
    'sedimentation', 'hematokrit', 'hematocrit', 'mcv', 'mch', 'mchc',
  ];
  ...
  DietValidationResult validate(OcrResult ocrResult) {
    if (!ocrResult.success || ocrResult.isEmpty) {
      return const DietValidationResult(
        isDiet: false,
        confidence: 0.0,
        message: 'Diyet listesinden okunabilir metin çıkarılamadı. '
    ...
    if (labDominant) {
      return DietValidationResult(
        ...
        message: 'Bu dosya diyet listesi gibi görünmüyor. '
    ...
    if (confidence < 0.6) {
      return DietValidationResult(
        isDiet: true,
        confidence: confidence,
        message: 'Bu dosya diyet listesi gibi görünüyor ancak emin değiliz. '
